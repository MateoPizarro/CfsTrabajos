...
var nombreAlumnno = rls.question("Ingrese el nombre del alumno(o una cadena vacia para terminar): ");
var promedio = 0;
while (nombreAlumnno !== "") {
    var partePractica = rls.questionInt("Ingrese la nota de la parte practica(entre 0 y 10): ");
    var parteProblemas = rls.questionInt("Ingrese la nota de la parte de problemas(entre 0 y 10): ");
    var parteTeorica = rls.questionInt("Ingrese la nota de la parte teorica(entre 0 y 10): ");
